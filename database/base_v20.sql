...
--
-- Table structure for table `discord_users_extended`
--

DROP TABLE IF EXISTS `discord_users_extended`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `kongou_episodes`
--

DROP TABLE IF EXISTS `kongou_episodes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kongou_episodes` (
  `eid` int NOT NULL,
...
--
-- Table structure for table `kongou_media_groups`
--

DROP TABLE IF EXISTS `kongou_media_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kongou_media_groups` (
...
--
-- Table structure for table `kongou_shows`
--

DROP TABLE IF EXISTS `kongou_shows`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kongou_shows` (
  `show_id` int NOT NULL,
  `media_group` varchar(128) DEFAULT NULL,
  `name` text NOT NULL,
  `original_name` text,
...
--
-- Table structure for table `kongou_shows_maps`
--

DROP TABLE IF EXISTS `kongou_shows_maps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kongou_shows_maps` (
  `show_id` int NOT NULL,
...
--
-- Table structure for table `kongou_watch_history`
--

DROP TABLE IF EXISTS `kongou_watch_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kongou_watch_history` (
  `usereid` varchar(255) NOT NULL,
  `user` varchar(128) NOT NULL,
  `eid` int NOT NULL,
  `viewed` float(6,5) DEFAULT '0.00000',
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`usereid`),
  UNIQUE KEY `kongou_watch_history_key_uindex` (`usereid`),
  KEY `kongou_watch_history_kanmi_records_eid_fk` (`eid`),
  CONSTRAINT `kongou_watch_history_kanmi_records_eid_fk` FOREIGN KEY (`eid`) REFERENCES `kanmi_records` (`eid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-10-07 12:53:38
